...
| M10 | Agent + Subagent inspector page | PENDING | **Major feature** — second top-level page; per-agent process tree (Claude Code / Cursor / Copilot / OpenClaw), recent commands, sub-agent invocations (was M07) |
